...
<body>
    <div id="container" style="width: 450px;">
        <div id="header">
            <img src="web/logo.png" alt="mini foro logo">
        </div>
        ...
        <div id="content">
            ...
            if ($_POST['orden'] == "Entrar") {
                if (isset($_POST['nombre']) && isset($_POST['contraseña']) && usuarioOK($_POST['nombre'], $_POST['contraseña'])) {
                    // Anoto el usuario en la session USUARIO CONECTADO

                    $_SESSION['usuario'] = $_POST['nombre'];
                    echo "<span class=\"gris\">Bienvenido <b>" . $_POST['nombre'] . "</b></span><br>";

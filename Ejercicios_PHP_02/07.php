...
<body>
	...
	function hallarColor(){
	    $colores=["red", "green", "blue", "black", "white"];
...
FOO;
	for ($i = 0; $i < 10; $i ++) {
	    ...
	    for ($j = 0; $j< 10; $j ++) {
	        $casillaColor = hallarColor();
	        echo "<td style=\"border-collapse:separate; border:1px solid grey; height:30px; background-color:$casillaColor"."\">"."</td>";
	    }
	    echo "</tr>";
	}
